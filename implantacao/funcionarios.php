...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
    <h2 class="text-center"><b>ATAS - FUNCIONÁRIOS</b></h2>
    <?php
            ...
            <div class="card mb-2 rounded-3 shadow-sw">
                <div class="card-header py-3">
                    <h3 class="my-0 fw-normal"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#6A5ACD" class="bi bi-people-fill" viewBox="0 0 16 16">
                        ...
                        </svg>&nbsp;&nbsp;<b>FUNCIONÁRIOS</b></h3>
                    <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal">CADASTRAR FUNCIONÁRIO</button>
                </div>
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            include 'conecta.php';
                            $pesquisa = mysqli_query($mysqli, "SELECT * FROM funcionarios");
                            ...
                            if ($row > 0) {
                                while ($registro = $pesquisa->fetch_array()) {
                                    ...
                                    echo "<td><a href='edifuncionarios.php?matricula=$matricula' data-bs-toggle='modal' data-bs-target='#exampleModal1$matricula' data-matricula='$matricula'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
                                    <path d='M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z'/>
                                    <path fill-rule='evenodd' d='M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z'/>
                                    </svg></a> | <a href='excfuncionarios.php?matricula=$matricula'><svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='red' class='bi bi-trash' viewBox='0 0 16 16'>
                                    <path d='M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0z'/>
                                    <path d='M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z'/>
                                    </svg></a></td>";
                                    echo "</tr>";
                                    echo "<div class='modal fade' id='exampleModal1$matricula' tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="cadfuncionarios.php" method="post">
                        ...
                        <input class="form-control" type="text" name="sexo" required placeholder="Digite o seu sexo"/>
                        <br/>
                        <label class="form-label">Data de nascimento</label>
                        <input class="form-control" type="date" name="data_nascimento" required placeholder="coloque sua data de nascimento"/>
                        <br/>
